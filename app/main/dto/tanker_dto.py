...
class TankerDTO:
    ...
    tanker = api.model('Tanker', {
        ...
        'kilometers': fields.String(required=False, description='Tanker number of kilometers'),
        ...
        'year': fields.String(required=False, description='Tanker production year'),
        'capacityInLitres': fields.String(required=False, description='Tanker fuel capacity in liters'),
        ...
        'noCompartments': fields.String(required=False, description='Tanker number of compartments'),
